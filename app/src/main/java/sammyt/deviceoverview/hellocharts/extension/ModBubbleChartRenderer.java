...
public class ModBubbleChartRenderer extends AbstractChartRenderer {
    ...
    public ModBubbleChartRenderer(Context context, Chart chart, BubbleChartDataProvider dataProvider) {
        super(context, chart);
    ...
    private void calculateBubbleScale(){
        ...
        Log.d(LOG_TAG, "maxZ: " + maxZ + " maxRadius: " + maxRadius
                + " scaleX: " + bubbleScaleX + " scaleY: " + bubbleScaleY);
